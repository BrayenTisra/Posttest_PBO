...
public class App {
    ...
    private static void tambahL() throws Exception {
        ...
        tambahL(Id, Judul, Pencipta, Tahun, Harga, Teknik, Aliran);
    }

    //Overloading
    private static void tambahL(String Id, String Judul, String Pencipta, int Tahun, int Harga, String Teknik, String Aliran) {
    ...
    public static void tambahP() throws IOException {
        ...
        tambahP(Id, Judul, Pencipta, Tahun, Harga, Bahan, Tinggi);
    }

    //Overloading
    public static void tambahP(String Id, String Judul, String Pencipta, int Tahun, int Harga, String Bahan, double Tinggi) {
